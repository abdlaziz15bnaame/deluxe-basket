        ...
        >
            {categories.map((category , index) => (
                <SwiperSlide key={index}>
                    <div
                    className="category-wrap flex flex-col items-center justify-center cursor-pointer">
                            <div className="category-image">
                                ...
                                <div
                            className="category-info my-2 flex flex-col justify-center items-center">
