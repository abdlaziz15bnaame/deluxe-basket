  ...
  return (
    ...
    <div className="px-[8%] lg:px-[12%] py-10">
      <div className="title my-10 w-full flex flex-col lg:flex-row justify-between items-start gap-5">
        <h1 className="text-5xl Unbounded mb-6 ">Weekly Top Vendors.</h1>
      </div>
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-6 gap-y-17 mt-20">
            {vendorsData.map((vendor , index) => ( 
                <div 
                    key={vendor.id}
                    className="vendor-wrap border border-gray-200 relative rounded-2xl p-5 shadow hover:shadow-lg hover:-translate-y-2
                    ...
                    >
                        <div className="flex flex-col items-center mb-3">
                            ...
                            />
                            <div className="mt-18">
                                <h2 className="text-2xl font-semibold hover:text-[var(--prim-color)] transition-all cursor-pointer">
                                    {vendor.title}
                                </h2>
